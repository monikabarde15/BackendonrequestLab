    ...
    <div className="flex justify-between">
        ...
        <button type="button" className="btn btn-primary ltr:ml-auto rtl:mr-auto" onClick={() => setActiveTab(activeTab === 1 ? 2 : 3)}>
            {activeTab === 3 ? 'Finish' : 'Next'}
                                            ...
                                            flex items-center justify-center rounded-full bg-[#f3f2ee] p-2.5 dark:bg-[#1b2e4b]`,onClick:()=>f(1),children:e(h,{})})}),e("li",{children:e("div",{className:`${n===2?"!bg-primary text-white":""}
                                            flex items-center justify-center rounded-full bg-[#f3f2ee] p-2.5 dark:bg-[#1b2e4b]`,onClick:()=>f(2),children:e(p,{className:"w-5 h-5"})})}),e("li",{children:e("div",{className:`${n===3?"!bg-primary text-white":""}
    ...
    <div className="flex justify-between">
        ...
        <button type="button" className="btn btn-primary ltr:ml-auto rtl:mr-auto" onClick={() => setActiveTab1(activeTab1 === 1 ? 2 : 3)}>
            {activeTab1 === 3 ? 'Finish' : 'Next'}
                                            ...
                                            flex items-center justify-center rounded-full bg-[#f3f2ee] p-2.5 dark:bg-[#1b2e4b]`,onClick:()=>y(1),children:e(h,{})}),e("span",{className:"text-center block mt-2",children:"Home"})]}),t("li",{children:[e("div",{className:`${c===2?"!bg-primary text-white":""}
                                            flex items-center justify-center rounded-full bg-[#f3f2ee] p-2.5 dark:bg-[#1b2e4b]`,onClick:()=>y(2),children:e(p,{className:"w-5 h-5"})}),e("span",{className:"text-center block mt-2",children:"About"})]}),t("li",{children:[e("div",{className:`${c===3?"!bg-primary text-white":""}
    ...
    <div className="flex justify-between">
        ...
        <button type="button" className="btn btn-primary ltr:ml-auto rtl:mr-auto" onClick={() => setActiveTab2(activeTab2 === 1 ? 2 : 3)}>
            {activeTab2 === 3 ? 'Finish' : 'Next'}
                                            ...
                                            bg-white dark:bg-[#253b5c] border-[3px] border-[#f3f2ee] dark:border-[#1b2e4b] flex justify-center items-center w-16 h-16 rounded-full`,onClick:()=>N(1),children:e(h,{})})}),e("li",{className:"mx-auto",children:e("button",{type:"button",className:`${r===2?"!border-primary !bg-primary text-white":""}
                                            bg-white dark:bg-[#253b5c] border-[3px] border-[#f3f2ee] dark:border-[#1b2e4b] flex justify-center items-center w-16 h-16 rounded-full`,onClick:()=>N(2),children:e(p,{className:"w-5 h-5"})})}),e("li",{className:"mx-auto",children:e("button",{type:"button",className:`${r===3?"!border-primary !bg-primary text-white":""}
        ...
        <button type="button" className="btn btn-primary ltr:ml-auto rtl:mr-auto" onClick={() => setActiveTab3(activeTab3 === 1 ? 2 : 3)}>
            {activeTab3 === 3 ? 'Finish' : 'Next'}
                                        ...
                                        bg-primary w-[15%] h-1 absolute ltr:left-0 rtl:right-0 top-[30px] m-auto -z-[1] transition-[width]`}),t("ul",{className:"mb-5 grid grid-cols-3",children:[t("li",{className:"mx-auto",children:[e("button",{type:"button",className:`${a===1?"!border-primary !bg-primary text-white":""}
                                                border-[3px] border-[#f3f2ee] bg-white dark:bg-[#253b5c] dark:border-[#1b2e4b] flex justify-center items-center w-16 h-16 rounded-full`,onClick:()=>x(1),children:e(h,{})}),e("span",{className:`${a===1?"text-primary ":""}text-center block mt-2`,children:"Home"})]}),t("li",{className:"mx-auto",children:[e("button",{type:"button",className:`${a===2?"!border-primary !bg-primary text-white":""}
                                                border-[3px] border-[#f3f2ee] bg-white dark:bg-[#253b5c] dark:border-[#1b2e4b] flex justify-center items-center w-16 h-16 rounded-full`,onClick:()=>x(2),children:e(p,{className:"w-5 h-5"})}),e("span",{className:`${a===2?"text-primary ":""}text-center block mt-2`,children:"About"})]}),t("li",{className:"mx-auto",children:[e("button",{type:"button",className:`${a===3?"!border-primary !bg-primary text-white":""}
        ...
        <button type="button" className="btn btn-primary ltr:ml-auto rtl:mr-auto" onClick={() => setActiveTab4(activeTab4 === 1 ? 2 : 3)}>
            {activeTab4 === 3 ? 'Finish' : 'Next'}
                                        ...
                                        bg-primary w-[15%] h-1 absolute ltr:left-0 rtl:right-0 top-[30px] m-auto -z-[1] transition-[width]`}),t("ul",{className:"mb-5 grid grid-cols-3",children:[e("li",{className:"mx-auto",children:e("button",{type:"button",className:`${l===1?"!border-primary !bg-primary text-white":""}
                                                bg-white dark:bg-[#253b5c] border-[3px] border-[#f3f2ee] dark:border-[#1b2e4b] flex justify-center items-center w-16 h-16`,onClick:()=>k(1),children:e(h,{})})}),e("li",{className:"mx-auto",children:e("button",{type:"button",className:`${l===2?"!border-primary !bg-primary text-white":""}
                                                bg-white dark:bg-[#253b5c] border-[3px] border-[#f3f2ee] dark:border-[#1b2e4b] flex justify-center items-center w-16 h-16`,onClick:()=>k(2),children:e(p,{className:"w-5 h-5"})})}),e("li",{className:"mx-auto",children:e("button",{type:"button",className:`${l===3?"!border-primary !bg-primary text-white":""}
        ...
        <button type="button" className="btn btn-primary ltr:ml-auto rtl:mr-auto" onClick={() => setActiveTab5(activeTab5 === 1 ? 2 : 3)}>
            {activeTab5 === 3 ? 'Finish' : 'Next'}
                                        ...
                                        bg-primary w-[15%] h-1 absolute ltr:left-0 rtl:right-0 top-[30px] m-auto -z-[1] transition-[width]`}),t("ul",{className:"mb-5 grid grid-cols-3",children:[t("li",{className:"mx-auto",children:[e("button",{type:"button",className:`${i===1?"!border-primary !bg-primary text-white":""}
                                                border-[3px] border-[#f3f2ee] bg-white dark:bg-[#253b5c] dark:border-[#1b2e4b] flex justify-center items-center w-16 h-16`,onClick:()=>w(1),children:e(h,{})}),e("span",{className:`${i===1?"text-primary ":""}text-center block mt-2`,children:"Home"})]}),t("li",{className:"mx-auto",children:[e("button",{type:"button",className:`${i===2?"!border-primary !bg-primary text-white":""}
                                                border-[3px] border-[#f3f2ee] bg-white dark:bg-[#253b5c] dark:border-[#1b2e4b] flex justify-center items-center w-16 h-16`,onClick:()=>w(2),children:e(p,{className:"w-5 h-5"})}),e("span",{className:`${i===2?"text-primary ":""}text-center block mt-2`,children:"About"})]}),t("li",{className:"mx-auto",children:[e("button",{type:"button",className:`${i===3?"!border-primary !bg-primary text-white":""}
